...
global $pass_data;
$pass_data = array(1 => array('page','count','category','genre','conditions','sort','from','limit'),
 				   2 => array('page','count','category','genre','conditions','sort','from','limit'),
				   3 => array('page','count','category','genre','conditions','sort','from','limit'));
